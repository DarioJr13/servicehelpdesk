<template>
  ...
  <div>
    ...
    :getAttach="getAttachments" :panel="panel" :tip-rule="formField.show_description_under_form_field">
    ...
    :actionBtn="getActionButtonObj" :apiParameters="getFaveoFormData[formUniqueKey] ? getFaveoFormData[formUniqueKey].formDataMap : {}" :isInlineForm="true" :rules="validationRules" :hint="formField.description" :strlength="75" :tip-rule="formField.show_description_under_form_field"></dynamic-select>

    <file-upload v-if="formField.unique === 'requester' && isMultipleRequester && panel !== 'client'" :label="formField.label" :value="selectedValue" :id="formField.unique" :name="formField.unique" :onChange="onChange" :required="isRequiredField" accept=".csv,.xlxs" :isInlineForm="true" rules="required" :tip-rule="formField.show_description_under_form_field"></file-upload>
    ...
    <dynamic-select v-if="formField.type === 'select'" :id="formField.unique" :label="formField.label" :multiple="false" :name="formField.unique" :elements="dropdownOptions" :value="selectedValue" :onChange="onChange" :required="isRequiredField" :optionLabel="optionLabel" :isInlineForm="true" :rules="validationRules" :hint="formField.description" :strlength="75" :tip-rule="formField.show_description_under_form_field"></dynamic-select>

    <dynamic-select v-if="formField.type === 'taggable'" :id="formField.unique" :label="formField.label" :multiple="true" :taggable="true" :name="formField.unique" :elements="[]" :value="selectedValue" :onChange="onChange" :required="isRequiredField" :optionLabel="optionLabel" :isInlineForm="true" :rules="validationRules" :hint="formField.description" :strlength="75" :tip-rule="formField.show_description_under_form_field"></dynamic-select>
    ...
    <checkbox-field v-if="formField.type === 'checkbox'" :name="formField.label" :label="formField.label" :hint="formField.description" :required="isRequiredField" :options="formField.options" :value="selectedValue" :onChange="onChange" :isInlineForm="true" :rules="validationRules" :tip-rule="formField.show_description_under_form_field"></checkbox-field>

    <file-upload v-if="formField.type === 'file'" :label="formField.label" :value="selectedValue" :name="formField.unique" :onChange="onChange" :required="isRequiredField" :id="formField.unique" accept="" :isInlineForm="true" :rules="validationRules" :hint="formField.description" :multiple="formField.unique!=='organisation_logo' " :tip-rule="formField.show_description_under_form_field"></file-upload>
...
export default {
  ...
  methods: {
    ...
    onChange (value, name) {
      if(name == 'help_topic_id' || name == 'department_id') {
        window.eventHub.$emit('updateDynamicSelect')
      }
