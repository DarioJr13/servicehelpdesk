            		...
            		var parser = new DOMParser();
					  	...
					  	anchors.forEach(anchor => {
					  		...
					  		if(anchor.href.includes(this.basePath())){
						  		...
						  		if(modifiedArr[0] == 'check-ticket' || modifiedArr[0] == 'department' || (modifiedArr[0] == 'service-desk' && modifiedArr[1] == 'products') || (modifiedArr[0] == 'service-desk' && modifiedArr[1] == 'vendor')) {
