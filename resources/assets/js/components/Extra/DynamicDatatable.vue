  ...
  methods: {
     ...
     */
      getHyperlinkInstance(componentName, keyName){
        ...
        return Vue.component(componentName, { props: ['data'], data() { return { href : 'href', text:'innerText', tag:'tag', keyVal : keyName}},
          ...
          methods : {
            ...
            getRoute(value,attr,keyValue) {
              ...
              if(par == undefined) {
                ...
                if(keyValue == 'name' && currentPath == 'department-performance' || currentPath == 'team-performance') {
          ...
          template: "<span>" +
            "<span v-if=data."+ keyName+"><span v-if=getRoute(data."+keyName+",href,keyVal)><router-link :tag=getRoute(data."+keyName+",tag,keyVal) :to=getRoute(data."+keyName+",href,keyVal)><span v-html=getRoute(data."+keyName+",text,keyVal)></span></router-link></span><span v-else v-html=" + absoluteHyperlinkPath + "></span></span>" +
            "<span v-else>--</span>"+
          "</span>"
        });
      },
