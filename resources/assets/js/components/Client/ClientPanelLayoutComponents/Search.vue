            ...
            <div class="form-inline">
                ...
                <div class="form-group input-group" style="width: 100%;">
                    ...
                    <input type="text" name="s" class="search-field form-control input-lg" v-model="search"
                           ...
                           title="Enter search term" :placeholder="lang('have_a_question?_type_your_search_term_here')" @click="showAdv"/>
            ...
            <div v-if="searchOpen" class="search-advance">
                ...
                <div class="row pt-2 pb-2">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="title_and_article" v-model="description" :disabled="name">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="title_only" v-model="name" :disabled="description">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="case_sensitive" v-model="case_sensitive">
                ...
                <div class="row">
                    ...
                    <dynamic-select :label="lang('category')"
                                    :multiple="false" name="category"
                                    classname="col-sm-6" apiEndpoint="/api/dependency/categories"
                                    :value="category" :onChange="onChange" :required="false" strlength="30">
                    </dynamic-select>

                    <dynamic-select :label="lang('tags')"
                                    :multiple="false" name="tag"
                                    classname="col-sm-6" apiEndpoint="/api/dependency/tags"
                                    :value="tag" :onChange="onChange" :required="false" strlength="30">
                    </dynamic-select>
                </div>
            </div>

            <a v-if="searchOpen" href="javascript:;" class="search-advance-button text-center" @click="onClickOutside">
...
export default {
    ...
    created () {
        ...
        window.eventHub.$on('doingSearch', this.onClickOutside);
    },
