					...
					<div class="clearfix">
						...
						<div id="comments" class="comments-area" :class="{align1: lang_locale == 'ar'}">
							...
							<div v-if="showEditor==1">
								...
								<button v-if="!openReply" class="btn btn-default btn-block" @click="toggleReply">
								...
								<div v-if="openReply" id="reply_threads" class="comment-respond form-border">
									...
									<form method="POST" action="" accept-charset="UTF-8" id="client-reply">
										...
										<dynamic-select v-if="showCC" :label="lang('cc')" :multiple="true" name="cc" :elements="ccArr" :value="cc" 
											:onChange="onChange" :clearable="cc ? true : false" classname="col-sm-12 pad_0" :taggable="true"
											:placeholder="lang('enter_email_addresses')" :labelStyle="labelStyle">

										</dynamic-select>

										<tiny-editor :value="reply" type="text" :onChange="onChange" name="reply" :label="lang('reply')"
											classname="row col-sm-12 client_timeline" :required="true" :lang="lang_locale" :labelStyle="labelStyle">
