		...
		<div class="card-body" v-if="!loading">
			...
			<div class="row">
				...
				<div class="col-md-3">
					...
					<button v-if="!isEnabled && !updating" type="button" class="btn btn-primary float-right" @click="toggleSwitch(1)">
					...
					<button v-if="updating" type="button" class="btn btn-primary float-right disabled">
