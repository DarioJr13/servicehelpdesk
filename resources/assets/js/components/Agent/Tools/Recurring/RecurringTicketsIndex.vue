		...
		<div class="card card-light ">
			...
			<div class="card-header">
				...
				<div class="card-tools">
					...
					<a v-if="from == 'admin'" :href="basePath()+panel+'/ticket/recur'" class="btn-tool" v-tooltip="lang('create_recur')">
			 	...
			 	responseAdapter({data}) {
					...
					return {
						...
						data: data.data.data.map(data => {
							...
							data.edit_url = self.panel ? self.panel + '/recur/' + data.id + '/edit' : self.basePath()  + '/recur/' + data.id + '/edit';;
