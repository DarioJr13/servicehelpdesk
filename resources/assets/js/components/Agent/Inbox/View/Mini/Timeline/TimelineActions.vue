<template>
	...
	<span>
		...
		<template v-if="!actions.block_ticket_actions">
		...
		<more-events v-if="!actions.block_ticket_actions" :actions="actionsList" :ticket="data" :updateDetails="reloadData">
...
<script>
	...
	export default {
		...
		components : {
			...
			'ticket-label' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/TicketLabel.vue'),
          
         'ticket-tag' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/TicketTags.vue'),

         'more-events' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/MoreEvents.vue'),
		}
	};
</script>
