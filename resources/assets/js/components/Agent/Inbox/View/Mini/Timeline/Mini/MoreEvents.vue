...
<script>
	...
	export default {
		...
		components : {
         ...
         'surrender-modal' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/SurrenderModal'),

         'change-dept-modal' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/DepartmentModal'),

         'approval-modal' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/ApprovalWorkflowModal'),

         'forward-modal' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/ForwardModal'),

         'due-date-modal' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/DueDateModal'),

         'generate-pdf-modal' : require('components/Agent/Inbox/View/Mini/Timeline/Mini/PdfModal'),
		}
	};
</script>
