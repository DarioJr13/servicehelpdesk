	...
	<tr :class="{'unanswered': ticket.isanswered == 0, 'active_ticket' : getStoredTicketId == ticket.id && timelineId}" v-bs-popover>
		...
		<td class="name td-ticket-details">
			...
			<div class="ticket_subject">
				...
				<h3 class="ticket-description-tip overdue_ticket break-word" @click="onRowClick(ticket.id)" @click.ctrl="redirectToTab(ticket.id)">
				...
				<div class="info-data">
					...
					<div class="information ellipsis">
						...
						<div class="ticket-list-custom-box">
							...
							<span v-if="field.value" style="color:#3c8dbc" v-html="field.value"/></span>
