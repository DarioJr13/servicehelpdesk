		...
		<div class="card card-light ">
			...
			<div class="card-header">
				...
				<div class="card-tools">
					...
					<router-link class="btn btn-tool" v-tooltip="trans('create_user')" to="/user/create">

						<i class="fas fa-plus"></i>
					</router-link>

					<router-link class="btn btn-tool" to="/user/export" v-tooltip="trans('export')">
	...
	export default {
		...
		data() {
			...
			return {
				...
				columns: ['name', 'user_name', 'email', 'phone', 'info', 'organizations', 'action'],
		...
		beforeMount(){
			...
			this.options = {
				...
				sortable: ['name', 'user_name', 'email', 'role'],

				filterable: ['name', 'user_name', 'email', 'phone', 'role','organizations'],
				...
				responseAdapter({data}) {
					return {
						...
						data: data.data.users.map(data => {
							...
							data.edit_url = data.role != 'user' ? '/agent/' + data.id + '/edit' : '/user/' + data.id + '/edit';
							...
							if(data.role !== 'user'){
								...
								data.agent_view_url = '/agent/' + data.id;	
							}
