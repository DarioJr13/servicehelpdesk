							...
							<div class="mt-3">
								...
								<div id="my_tic">
									...
									<dept-tickets-table :category="category" :id="id" :tickets="ticketsData" :key="category" 
										:apiUrl="apiUrl" :componentTitle="componentTitle" scroll_to="dept-tickets-table" :isCalledFromAdmin="true">
...
<script>
	...
	export default {
		...
		components : {
			...
			'dept-tickets-table' : require('components/Agent/TicketsComponents/TicketsTable'),
