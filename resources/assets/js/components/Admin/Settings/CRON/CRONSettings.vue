									...
									<div class="info-box">
									  ...
									  <div class="info-box-content">
										 ...
										 <div class="row">
											  ...
											  <div v-if="job.active" class="col-md-6 mt-13" id="fetching-command-block">
                                  ...
                                  <option :value="time.id">{{time.name}}</option>
														...
														<div v-if="job.value =='dailyAt'" class="col-sm-6" id="fetching-daily-at">
															...
															<form-field-template :label="'time'" :labelStyle="labelStyle" :name="'job_list.'+job.job+'.time'" classname="col-sm-12">
																...
																<input class="form-control" placeholder="HH:MM" :name="'job_list.'+job.job+'.time'" type="text" v-model="job.daily_time">
															</form-field-template>
														</div>
													</div>
											  </div>
...
<style scoped>
	...
	.checkbox_align {
		width: 13px; height: 13px; padding: 0; margin:0; vertical-align: bottom; position: relative; top: -2px; overflow: hidden;
	}
