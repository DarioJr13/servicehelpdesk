            ...
            <div class="card card-light">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <text-field id="client-id" :label="lang('client-id')" :value="client_id" type="text" name="client_id" :onChange="onChange" 
                            classname="col-sm-6" :required="true">
                        
                        </text-field>

                        <text-field id="client-secret" :label="lang('client-secret')" :value="client_secret" type="text" name="client_secret" :onChange="onChange" 
                            classname="col-sm-6" :required="true">
                    ...
                    <div class="row">
                        ...
                        <text-field id="redirect-url" :label="lang('redirect-url')" :value="redirect" type="text" name="redirect" :onChange="onChange" 
                            classname="col-sm-6" :required="true">
                        
                        </text-field> 

                        <radio-button :options="radioOptions" :label="'Activate login via '+providerName" name="status" :value="status"
