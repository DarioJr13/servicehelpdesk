		...
		<div class="card card-light" v-if="hasDataPopulated">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<text-field :label="trans('name')" type="text" :value="name" name="name" class="col-sm-3" :required="true" :onChange="onChange">
					
					</text-field>

					<number-field :label="trans('display_order')" :value="order" name="order" classname="col-sm-3" :onChange="onChange" 
		          ...
		          <div class="col-sm-3 form-group" :class="{'has-error' : showErr}">
						...
						<color-picker :color="icon_color" v-model="icon_color" :showError="showErr" />
				...
				<div class="row">
					...
					<dynamic-select v-if="!visibility_for_client" :label="trans('status_to_display')" :multiple="false" name="secondary_status"   
						classname="col-sm-3" apiEndpoint="/api/dependency/statuses?client_visibility=1" :value="secondary_status" 
				...
				<div class="row">
					...
					<tiny-editor :value="message" :onChange="onChange" name="message" :label="trans('message')"
						classname="col-sm-12" :required="true" :lang="'en'" :hint="trans('this_message_will_be_displayed_in_the_thread_as_internal_note')">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						...
						<label class="label_align" name="is_default">
							...
							<input class="checkbox_align" type="checkbox" name="is_default" id="is_default" v-model="is_default">
								&nbsp;{{trans('make_system_default_for_selected_purpose')}}
						</label>
					</div>
				</div>
			</div>
...
<script>
	...
	import NumberField from "components/MiniComponent/FormField/NumberField";
	...
	import RadioButton from 'components/MiniComponent/FormField/RadioButton';
